...
namespace Eat.EditGrade
{
    public class TopBar
    {
        public static double Height { get => DeviceInfo.HeightScaling * 0.25; }
    ...
    public class GradeSelectionFrame
    {
        ...
        public static double FontSize { get => Height * 0.45; }
    }
    ...
    public class SelectionPanel
    {
        ...
        public static double Width { get => DeviceInfo.WidthScaling; }
        public static float CornerRadius { get => (float)(DeviceInfo.HeightScaling * 0.01); }
        public static Thickness Margin { get => new Thickness(Width * 0.05, Height * 0.03, Width * 0.05, 0); }
