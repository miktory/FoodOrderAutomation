...
namespace Eat.SelectMenu
{
    public class SelectMenuPopUp
    {
    ...
    {
        public static double Height { get => SelectMenuPopUp.Height * 0.65; }
        ...
        public static Thickness NameMargin { get => new Thickness(Width * 0.05, 0, 0, 0); }
        public static double MenuNameFontSize { get => Height * 0.1; }
        public static float CornerRadius { get => (float)(DeviceInfo.HeightScaling * 0.01); }
