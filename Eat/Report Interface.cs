...
namespace Eat.Report
{
    ...
    public class SelectionPanel
    {
        ...
        public static double Width { get => DeviceInfo.WidthScaling; }
        public static float CornerRadius { get => (float)(DeviceInfo.HeightScaling * 0.01); }
        public static Thickness Margin { get => new Thickness(Width * 0.05, Height * 0.05, Width * 0.05, Height* 0.05); }
    ...
    {
        public static float CornerRadius { get => (float)(DeviceInfo.HeightScaling * 0.01); }
        public static double NameFontSize { get => DeviceInfo.HeightScaling * 0.03; }
    }
    public class ContextFrame
    {
        public static double Height { get => DeviceInfo.HeightScaling * 0.05; }
        public static float CornerRadius { get => (float)(DeviceInfo.HeightScaling * 0.01); }
        public static double FontSize { get => DeviceInfo.HeightScaling * 0.02; }
    }
